...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: AiCharactersWidget.routeName,
          path: AiCharactersWidget.routePath,
          requireAuth: true,
          builder: (context, params) => AiCharactersWidget(),
        ),
        FFRoute(
          name: NewAuthPageWidget.routeName,
          path: NewAuthPageWidget.routePath,
          builder: (context, params) => NewAuthPageWidget(),
        ),
        FFRoute(
