...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFE9EDF1);
  late Color tertiary = const Color(0xFF003662);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF6A7185);
  ...
  late Color ivory = const Color(0xFFFFFFF0);
  late Color champagne = const Color(0xFFF7E7CE);
  late Color golden = const Color(0xFFDAA520);
  late Color paleGold = const Color(0xFFE6BE8A);
  late Color deepGold = const Color(0xFFB8860B);
  late Color black = const Color(0xFF000000);
  late Color beige = const Color(0xFFEDDCCA);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF012A4A);
  late Color secondary = const Color(0xFF2E2E2E);
  late Color tertiary = const Color(0xFFE0F1FF);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF95A1AC);
  late Color primaryBackground = const Color(0xFF101213);
  late Color secondaryBackground = const Color(0xFF293035);
  late Color accent1 = const Color(0xFFEEEEEE);
  ...
  late Color deepGold = const Color(0xFFB8860B);
  late Color black = const Color(0xFF000000);
  late Color beige = const Color(0xFF012D52);
}
