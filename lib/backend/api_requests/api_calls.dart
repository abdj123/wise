    ...
    final ffApiRequestBody = '''
{
  ...
  "overrideConfig": {
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl:
          'https://dddaaannniii-chatback.hf.space/api/v1/prediction/$chatKey',
...
class GetChatHistoryCall {
  static Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl:
          'https://dddaaannniii-chatback.hf.space/api/v1/chatmessage/$chatKey',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer HP3Zx_KzM5Q3a6Hm0XnnUtpZHgiezsg_aOUsTbyr8CU',
      },
      params: {
        'sessionId': sessionId,
      },
